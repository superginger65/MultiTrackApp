...
let trackToPlay = `Tracks/Audio 2 Duet 2 Rag Blues Mix nwith met.mp3`;
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track4Mute) {
      trackToPlay = `Tracks/Audio 2 Duet 2 Rag Blues Mix nwith met.mp3`; 
    } else {
      trackToPlay = `Tracks/Audio 2 Duet 2 Rag Blues Mix no met.mp3`;
    }
    if (shouldPlay) {
