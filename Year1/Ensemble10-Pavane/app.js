...
let trackToPlay = `Tracks/With Metronome/Combinations/Audio 37 Ens 10 Pavane Mix with met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 37 Ens 10 Pavane Mix with met.mp3`; 
    } else if (track1Mute && !track2Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 37 Ens 10 Pavane Gtr 2+3 with met.mp3`;
    } else if (!track1Mute && track2Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 37 Ens 10 Pavane Gtr 1+3 with met.mp3`;
    } else if (!track1Mute && !track2Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 37 Ens 10 Pavane Gtr 1+2 with met.mp3`;
    } else if (!track1Mute && !track2Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 37 Ens 10 Pavane mix no met.mp3`;
    } else if (track1Mute && track2Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 37 Ens 10 Pavane Gtr 3 with met.mp3`;
    } else if (!track1Mute && track2Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 37 Ens 10 Pavane Gtr 1 with met.mp3`;
    } else if (!track1Mute && !track2Mute && track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 37 Ens 10 Pavane Gtr 1+2 no met.mp3`;
    } else if (track1Mute && !track2Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 37 Ens 10 Pavane Gtr 2 with met.mp3`;
    } else if (track1Mute && !track2Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 37 Ens 10 Pavane Gtr 2+3 no met.mp3`;
    } else if (!track1Mute && track2Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 37 Ens 10 Pavane Gtr 1+3 no met.mp3`;
    } else if (track1Mute && track2Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 37 Ens 10 Pavane Met with met.mp3`;
    } else if (track1Mute && track2Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 37 Ens 10 Pavane Gtr 3 no met.mp3`;
    } else if (track1Mute && !track2Mute && track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 37 Ens 10 Pavane Gtr 2 no met.mp3`;
    } else if (!track1Mute && track2Mute && track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 37 Ens 10 Pavane Gtr 1 no met.mp3`;
    } else if (track1Mute && track2Mute && track3Mute && track4Mute) {
