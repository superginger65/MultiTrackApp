...
let trackToPlay = `Tracks/With Metronome/Combinations/Audio 43 Ens 11 Ballade Mix with met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 43 Ens 11 Ballade Mix with met.mp3`; 
    } else if (track1Mute && !track2Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 43 Ens 11 Ballade Gtr 2 + Gtr 3 with met.mp3`;
    } else if (!track1Mute && track2Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 43 Ens 11 Ballade Gtr 1 + Gtr 3 with met.mp3`;
    } else if (!track1Mute && !track2Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 43 Ens 11 Ballade Gtr 1 + Gtr 2 with met.mp3`;
    } else if (!track1Mute && !track2Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 43 Ens 11 Ballade Mix no met.mp3`;
    } else if (track1Mute && track2Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 43 Ens 11 Ballade Gtr 3 with met.mp3`;
    } else if (!track1Mute && track2Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 43 Ens 11 Ballade Gtr 1 with met.mp3`;
    } else if (!track1Mute && !track2Mute && track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 43 Ens 11 Ballade Gtr 1 +Gtr 2 no met.mp3`;
    } else if (track1Mute && !track2Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 43 Ens 11 Ballade Gtr 2 with met.mp3`;
    } else if (track1Mute && !track2Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 43 Ens 11 Ballade Gtr 2 +Gtr 3 no met.mp3`;
    } else if (!track1Mute && track2Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 43 Ens 11 Ballade Gtr 1 +Gtr 3 no met.mp3`;
    } else if (track1Mute && track2Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 43 Ens 11 Ballade Met with met.mp3`;
    } else if (track1Mute && track2Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 43 Ens 11 Ballade Gtr 3 no met.mp3`;
    } else if (track1Mute && !track2Mute && track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 43 Ens 11 Ballade Gtr 2 no met.mp3`;
    } else if (!track1Mute && track2Mute && track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 43 Ens 11 Ballade Gtr 1 no met.mp3`;
    } else if (track1Mute && track2Mute && track3Mute && track4Mute) {
