...
let trackToPlay = `Tracks/Audio 20 Ensemble 2 Moderato with Met.mp3`;
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track4Mute) {
      trackToPlay = `Tracks/Audio 20 Ensemble 2 Moderato with Met.mp3`; 
    } else {
      trackToPlay = `Tracks/Audio 20 Ensemble 2 Moderato no Met.mp3`;
    }
    if (shouldPlay) {
