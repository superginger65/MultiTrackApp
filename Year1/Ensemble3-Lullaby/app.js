...
let trackToPlay = `Tracks/Audio 21 Ensemble 3 Lullaby Mix with Met.mp3`;
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track4Mute) {
      trackToPlay = `Tracks/Audio 21 Ensemble 3 Lullaby Mix with Met.mp3`; 
    } else {
      trackToPlay = `Tracks/Audio 21 Ensemble 3 Lullaby Mix no Met.mp3`;
    }
    if (shouldPlay) {
