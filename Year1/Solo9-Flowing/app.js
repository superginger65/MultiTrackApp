...
let trackToPlay = `Tracks/With Metronome/Combinations/Audio 31 Solo 9 Flowing Mix with met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute && !track3Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 31 Solo 9 Flowing Mix with met.mp3`; 
    } else if (track1Mute && !track2Mute && !track3Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 31 Solo 9 Flowing Teach Gtr with met.mp3`;
    } else if (!track1Mute && track2Mute && !track3Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 31 Solo 9 Flowing Stud Gtr with met.mp3`;
    } else if (track1Mute && track2Mute && !track3Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 31 Solo 9 Flowing Met with met.mp3`;
    } else if (!track1Mute && track2Mute && track3Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 31 Solo 9 Flowing Stud Gtr no met.mp3`;
    } else if (!track1Mute && !track2Mute && track3Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 31 Solo 9 Flowing mix no met with strum.mp3`;
    } else if (track1Mute && !track2Mute && track3Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 31 Solo 9 Flowing Teach Gtr no met.mp3`;
    } else if (track1Mute && track2Mute && track3Mute) {
