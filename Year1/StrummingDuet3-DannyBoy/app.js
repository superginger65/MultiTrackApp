...
let trackToPlay = `Tracks/With Metronome/Combinations/Audio 32 Strum Duet 3 Danny Boy Mix with met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 32 Strum Duet 3 Danny Boy Mix with met.mp3`; 
    } else if (!track1Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 32 Strum Duet 3 Danny Boy soft mix no met.mp3`;
    } else if (track1Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 32 Strum Duet 3 Danny Boy Vocal with met.mp3`;
    } else if (!track1Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 32 Strum Duet 3 Danny Boy Strum Gtr with met.mp3`;
    } else if (track1Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 32 Strum Duet 3 Danny Boy Met with met.mp3`;
    } else if (track1Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 32 Strum Duet 3 Danny Boy Vocal no met.mp3`;
    } else if (!track1Mute && track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 32 Strum Duet 3 Danny Boy Strum Gtr no met.mp3`;
    } else if (track1Mute && track3Mute && track4Mute) {
