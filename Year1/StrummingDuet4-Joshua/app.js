...
let trackToPlay = `Tracks/With Metronome/Combinations/Audio 35 Joshua Mix with Met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 35 Joshua Mix with Met.mp3`; 
    } else if (!track1Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 35 Joshua Mix no Met.mp3`;
    } else if (track1Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 35 Joshua Vocals and Solo with Met.mp3`;
    } else if (!track1Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 35 Joshua Strum Gtr with Met.mp3`;
    } else if (track1Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 35 Joshua Met with Met.mp3`;
    } else if (track1Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 35 Joshua Vocals and Solo no Met.mp3`;
    } else if (!track1Mute && track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 35 Joshua Strum Gtr no Met.mp3`;
    } else if (track1Mute && track3Mute && track4Mute) {
