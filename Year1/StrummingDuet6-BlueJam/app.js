...
let trackToPlay = `Tracks/With Metronome/Combinations/Audio 40 Strum 6 Blue Jam Mix with met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 40 Strum 6 Blue Jam Mix with met.mp3`; 
    } else if (!track1Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 40 Strum 6 Blue Jam Mix no met.mp3`;
    } else if (track1Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 40 Strum 6 Blue Jam Teach Gtr with met.mp3`;
    } else if (!track1Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 40 Strum 6 Blue Jam Stud Gtr with met.mp3`;
    } else if (track1Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 40 Strum 6 Blue Jam Met with met.mp3`;
    } else if (track1Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 40 Strum 6 Blue Jam Teach Gtr no met.mp3`;
    } else if (!track1Mute && track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 40 Strum 6 Blue Jam Stud Gtr no met.mp3`;
    } else if (track1Mute && track3Mute && track4Mute) {
