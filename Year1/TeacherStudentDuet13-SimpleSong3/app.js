...
let trackToPlay = `Tracks/Audio 15 Duet 13 Simple Song 3 Mix with Met.mp3`;
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track4Mute) {
      trackToPlay = `Tracks/Audio 15 Duet 13 Simple Song 3 Mix with Met.mp3`; 
    } else {
      trackToPlay = `Tracks/Audio 15 Duet 13 Simple Song 3 Mix no Met.mp3`;
    }
    if (shouldPlay) {
