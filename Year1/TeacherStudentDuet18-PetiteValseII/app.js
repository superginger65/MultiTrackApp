...
let trackToPlay = `Tracks/With Metronome/Combinations/Audio 24 Duet 18 Petite Valse II mix with Met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 24 Duet 18 Petite Valse II mix with Met.mp3`; 
    } else if (!track1Mute && !track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 24 Duet 18 Petite Valse II Mix no Met.mp3`;
    } else if (!track1Mute && track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 24 Duet 18 Petite Valse II Gtr1 with Met.mp3`;
    } else if (track1Mute && !track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 24 Duet 18 Petite Valse II Gtr2 with Met.mp3`;
    } else if (track1Mute && track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 24 Duet 18 Petite Valse II met with Met.mp3`;
    } else if (track1Mute && !track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 24 Duet 18 Petite Valse II Gtr2 no Met.mp3`;
    } else if (!track1Mute && track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 24 Duet 18 Petite Valse II Gtr1 no Met.mp3`;
    } else if (track1Mute && track2Mute && track4Mute) {
