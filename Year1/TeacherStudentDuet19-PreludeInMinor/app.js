...
let trackToPlay = `Tracks/No Metronome/Combinations/Audio 27 Duet 19 Prelude in Minor mix no Met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute && !track3Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 27 Duet 19 Prelude in Minor mix no Met.mp3`; 
    } else if (!track1Mute && !track2Mute && track3Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 27 Duet 19 Prelude in Minor Gtr1+2  no Met.mp3`;
    } else if (track1Mute && !track2Mute && !track3Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 27 Duet 19 Prelude in Minor Gtr2+ strum no Met.mp3`;
    } else if (!track1Mute && track2Mute && !track3Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 27 Duet 19 Prelude in Minor Gtr1+ strum no Met.mp3`;
    } else if (track1Mute && track2Mute && !track3Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 27 Duet 19 Prelude in Minor Gtr Strum no Met.mp3`;
    } else if (track1Mute && !track2Mute && track3Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 27 Duet 19 Prelude in Minor Gtr 2 no Met.mp3`;
    } else if (!track1Mute && track2Mute && track3Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 27 Duet 19 Prelude in Minor Gtr 1 no Met.mp3`;
    } else if (track1Mute && track2Mute && track3Mute) {
