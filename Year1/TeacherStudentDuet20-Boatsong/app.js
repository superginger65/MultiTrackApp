...
let trackToPlay = `Tracks/No Metronome/Combinations/Audio 33 Duet 20 BoatSong mix no Met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute && !track3Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 33 Duet 20 BoatSong mix no Met.mp3`; 
    } else if (!track1Mute && !track2Mute && track3Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 33 Duet 20 BoatSong Gtr1+2 no Met.mp3`;
    } else if (track1Mute && !track2Mute && !track3Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 33 Duet 20 BoatSong Gtr2+strum  no Met.mp3`;
    } else if (!track1Mute && track2Mute && !track3Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 33 Duet 20 BoatSong Gtr1+strum  no Met.mp3`;
    } else if (track1Mute && track2Mute && !track3Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 33 Duet 20 BoatSong Gtr Strum no Met.mp3`;
    } else if (track1Mute && !track2Mute && track3Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 33 Duet 20 BoatSong Gtr2 no Met.mp3`;
    } else if (!track1Mute && track2Mute && track3Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 33 Duet 20 BoatSong Gtr1 no Met.mp3`;
    } else if (track1Mute && track2Mute && track3Mute) {
