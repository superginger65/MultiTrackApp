...
let trackToPlay = `Tracks/No Metronome/Combinations/Audio 36 Duet 21  SimpleSongVI Mix no Met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute && !track3Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 36 Duet 21  SimpleSongVI Mix no Met.mp3`; 
    } else if (!track1Mute && !track2Mute && track3Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 36 Duet 21  SimpleSongVI Gtr 1+2 no Met.mp3`;
    } else if (track1Mute && !track2Mute && !track3Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 36 Duet 21  SimpleSongVI Gtr 2+strum no Met.mp3`;
    } else if (!track1Mute && track2Mute && !track3Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 36 Duet 21  SimpleSongVI Gtr 1+strum no Met.mp3`;
    } else if (track1Mute && track2Mute && !track3Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 36 Duet 21  SimpleSongVI Strum no Met.mp3`;
    } else if (track1Mute && !track2Mute && track3Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 36 Duet 21  SimpleSongVI Gtr2  no Met.mp3`;
    } else if (!track1Mute && track2Mute && track3Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 36 Duet 21  SimpleSongVI Gtr1  no Met.mp3`;
    } else if (track1Mute && track2Mute && track3Mute) {
