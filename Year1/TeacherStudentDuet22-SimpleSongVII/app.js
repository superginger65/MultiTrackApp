...
let trackToPlay = `Tracks/No Metronome/Combinations/Audio 39 Duet 22  SimpleSongVII mix no Met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 39 Duet 22  SimpleSongVII mix no Met.mp3`; 
    } else if (track1Mute && !track2Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 39 Duet 22  SimpleSongVII Gtr 2 no Met.mp3`;
    } else if (!track1Mute && track2Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 39 Duet 22  SimpleSongVII Gtr 1 no Met.mp3`;
    } else if (track1Mute && track2Mute) {
