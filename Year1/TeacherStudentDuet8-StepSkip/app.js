...
let trackToPlay = `Tracks/With Metronome/Combinations/Audio 9 Duet 8 Step Skip Mix with Met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 9 Duet 8 Step Skip Mix with Met.mp3`; 
    } else if (track1Mute && !track2Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 9 Duet 8 Step Skip Teach strum with Met.mp3`;
    } else if (!track1Mute && track2Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 9 Duet 8 Step Skip Stud strum with Met.mp3`;
    } else if (!track1Mute && !track2Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 9 Duet 8 Step Skip Stud Teach with Met.mp3`;
    } else if (!track1Mute && !track2Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 9 Duet 8 Step Skip Mix no Met.mp3`;
    } else if (track1Mute && track2Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 9 Duet 8 Step Skip Strum with Met.mp3`;
    } else if (!track1Mute && track2Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 9 Duet 8 Step Skip Student with Met.mp3`;
    } else if (!track1Mute && !track2Mute && track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 9 Duet 8 Step Skip Stud Teach no Met.mp3`;
    } else if (track1Mute && !track2Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 9 Duet 8 Step Skip Teacher with Met.mp3`;
    } else if (track1Mute && !track2Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 9 Duet 8 Step Skip Teach Strum no Met.mp3`;
    } else if (!track1Mute && track2Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 9 Duet 8 Step Skip Stud Strum no Met.mp3`;
    } else if (track1Mute && track2Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 9 Duet 8 Step Skip Metronome with Met.mp3`;
    } else if (track1Mute && track2Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 9 Duet 8 Step Skip Strum no Met.mp3`;
    } else if (track1Mute && !track2Mute && track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 9 Duet 8 Step Skip Teacher no Met.mp3`;
    } else if (!track1Mute && track2Mute && track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 9 Duet 8 Step Skip Student no Met.mp3`;
    } else if (track1Mute && track2Mute && track3Mute && track4Mute) {
