...
let trackToPlay = `Tracks/With Metronome/Combinations/Audio 25 Ens 11 Kemps Jig mix with Met.mp3`;
...
let track5Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute && !track3Mute && !track4Mute && !track5Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 25 Ens 11 Kemps Jig mix with Met.mp3`; 
    } else if (track1Mute && !track2Mute && !track3Mute && !track4Mute && !track5Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR 2+3+4 with Met.mp3`;
    } else if (!track1Mute && track2Mute && !track3Mute && !track4Mute && !track5Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR 1+3+4 with Met.mp3`;
    } else if (!track1Mute && !track2Mute && track3Mute && !track4Mute && !track5Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR 1+2+4 with Met.mp3`;
    } else if (!track1Mute && !track2Mute && !track3Mute && track4Mute && !track5Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR1+2+3 with Met.mp3`;
    } else if (track1Mute && track2Mute && !track3Mute && !track4Mute && !track5Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR 3+4 with Met.mp3`;
    } else if (track1Mute && !track2Mute && track3Mute && !track4Mute && !track5Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR 2+4 with Met.mp3`;
    } else if (track1Mute && !track2Mute && !track3Mute && track4Mute && !track5Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR2+3 with Met.mp3`;
    } else if (!track1Mute && track2Mute && track3Mute && !track4Mute && !track5Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR 1+4 with Met.mp3`;
    } else if (!track1Mute && track2Mute && !track3Mute && track4Mute && !track5Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR1+3 with Met.mp3`;
    } else if (!track1Mute && !track2Mute && track3Mute && track4Mute && !track5Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR1+2 with Met.mp3`;
    } else if (track1Mute && track2Mute && track3Mute && !track4Mute && !track5Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 25 Ens 11 Kemps Jig GTR 4 Contra  with Met.mp3`;
    } else if (track1Mute && track2Mute && !track3Mute && track4Mute && !track5Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 25 Ens 11 Kemps Jig GTR 3 with Met.mp3`;
    } else if (track1Mute && !track2Mute && track3Mute && track4Mute && !track5Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 25 Ens 11 Kemps Jig GTR 2 with Met.mp3`;
    } else if (!track1Mute && track2Mute && track3Mute && track4Mute && !track5Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 25 Ens 11 Kemps Jig GTR 1 with Met.mp3`;
    } else if (track1Mute && track2Mute && track3Mute && track4Mute && !track5Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 25 Ens 11 Kemps Jig Met with Met.mp3`;
    } else if (!track1Mute && !track2Mute && !track3Mute && !track4Mute && track5Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 25 Ens 11 Kemps Jig Mix no Met.mp3`;
    } else if (track1Mute && !track2Mute && !track3Mute && !track4Mute && track5Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR2+3+4 no Met.mp3`;
    } else if (!track1Mute && track2Mute && !track3Mute && !track4Mute && track5Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR1+3+4 no Met.mp3`;
    } else if (!track1Mute && !track2Mute && track3Mute && !track4Mute && track5Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR1+2+4 no Met.mp3`;
    } else if (!track1Mute && !track2Mute && !track3Mute && track4Mute && track5Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR1+2+3 no Met.mp3`;
    } else if (track1Mute && track2Mute && !track3Mute && !track4Mute && track5Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR3+4 no Met.mp3`;
    } else if (track1Mute && !track2Mute && track3Mute && !track4Mute && track5Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR2+4 no Met.mp3`;
    } else if (track1Mute && !track2Mute && !track3Mute && track4Mute && track5Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR2+3 no Met.mp3`;
    } else if (!track1Mute && track2Mute && track3Mute && !track4Mute && track5Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR1+4 no Met.mp3`;
    } else if (!track1Mute && track2Mute && !track3Mute && track4Mute && track5Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR1+3 no Met.mp3`;
    } else if (!track1Mute && !track2Mute && track3Mute && track4Mute && track5Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 25 Ens 11 Kemps Jig GTR1+2 no Met.mp3`;
    } else if (track1Mute && track2Mute && track3Mute && !track4Mute && track5Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 25 Ens 11 Kemps Jig GTR4 Contra no Met.mp3`;
    } else if (track1Mute && track2Mute && !track3Mute && track4Mute && track5Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 25 Ens 11 Kemps Jig GTR3 no Met.mp3`;
    } else if (track1Mute && !track2Mute && track3Mute && track4Mute && track5Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 25 Ens 11 Kemps Jig GTR2 no Met.mp3`;
    } else if (!track1Mute && track2Mute && track3Mute && track4Mute && track5Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 25 Ens 11 Kemps Jig GTR1 no Met.mp3`;
    } else if (track1Mute && track2Mute && track3Mute && track4Mute && track5Mute) {
