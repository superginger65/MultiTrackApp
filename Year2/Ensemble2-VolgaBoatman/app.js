...
let trackToPlay = `Tracks/Audio 7 Ens 2 Volga Boatman Mix with Met.mp3`;
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track4Mute) {
      trackToPlay = `Tracks/Audio 7 Ens 2 Volga Boatman Mix with Met.mp3`; 
    } else {
      trackToPlay = `Tracks/Audio 7 Ens 2 Volga Boatman Mix no Met.mp3`;
    }
    if (shouldPlay) {
