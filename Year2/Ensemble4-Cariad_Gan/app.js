...
let trackToPlay = `Tracks/With Metronome/Combinations/Audio 11 Ens 4 Cariad Gan Mix with Met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 11 Ens 4 Cariad Gan Mix with Met.mp3`; 
    } else if (track1Mute && !track2Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 11 Ens 4 Cariad Gan Gtr 2+3 with Met.mp3`;
    } else if (!track1Mute && track2Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 11 Ens 4 Cariad Gan Gtr 1+3 with Met.mp3`;
    } else if (!track1Mute && !track2Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 11 Ens 4 Cariad Gan Gtr 1+2 with Met.mp3`;
    } else if (!track1Mute && !track2Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 11 Ens 4 Cariad Gan Mix no Met.mp3`;
    } else if (track1Mute && track2Mute && !track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 11 Ens 4 Cariad Gan Gtr 3 with Met.mp3`;
    } else if (!track1Mute && track2Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 11 Ens 4 Cariad Gan Gtr 1 with Met.mp3`;
    } else if (!track1Mute && !track2Mute && track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 11 Ens 4 Cariad Gan Gtr1+2  no Met.mp3`;
    } else if (track1Mute && !track2Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 11 Ens 4 Cariad Gan Gtr 2 with Met.mp3`;
    } else if (track1Mute && !track2Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 11 Ens 4 Cariad Gan Gtr2+3  no Met.mp3`;
    } else if (!track1Mute && track2Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 11 Ens 4 Cariad Gan Gtr1+3  no Met.mp3`;
    } else if (track1Mute && track2Mute && track3Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 11 Ens 4 Cariad Gan Met with Met.mp3`;
    } else if (track1Mute && track2Mute && !track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 11 Ens 4 Cariad Gan Gtr3  no Met.mp3`;
    } else if (track1Mute && !track2Mute && track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 11 Ens 4 Cariad Gan Gtr2  no Met.mp3`;
    } else if (!track1Mute && track2Mute && track3Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 11 Ens 4 Cariad Gan Gtr1  no Met.mp3`;
    } else if (track1Mute && track2Mute && track3Mute && track4Mute) {
