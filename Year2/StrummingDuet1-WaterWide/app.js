...
let trackToPlay = `Tracks/With Metronome/Combinations/Audio 3 Strumm Duet 1 Water Wide mix with met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 3 Strumm Duet 1 Water Wide mix with met.mp3`;
    } else if (!track1Mute && track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 3 Strumm Duet 1 Water Wide GTR with met.mp3`;
    } else if (!track1Mute && !track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 3 Strumm Duet 1 Water Wide mix no met.mp3`;
    } else if (track1Mute && !track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 3 Strumm Duet 1 Water Wide Vocal with met.mp3`;
    } else if (track1Mute && track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 3 Strumm Duet 1 Water Wide Met with met.mp3`;
    } else if (track1Mute && !track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 3 Strumm Duet 1 Water Wide Vocal no met.mp3`;
    } else if (!track1Mute && track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 3 Strumm Duet 1 Water Wide GTR no met.mp3`;
    } else if (track1Mute && track2Mute && track4Mute) {
