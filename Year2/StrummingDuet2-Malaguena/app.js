...
let trackToPlay = `Tracks/Audio 9 Strum Duet 2 Mix with met.mp3`;
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track4Mute) {
      trackToPlay = `Tracks/Audio 9 Strum Duet 2 Mix with met.mp3`; 
    } else {
      trackToPlay = `Tracks/Audio 9 Strum Duet 2 Mix no met.mp3`;
    }
    if (shouldPlay) {
