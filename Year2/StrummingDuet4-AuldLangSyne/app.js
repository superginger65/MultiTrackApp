...
let trackToPlay = `Tracks/With Metronome/Combinations/Audio 12 Strum 4 Auld Lang Syn Mix with met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 12 Strum 4 Auld Lang Syn Mix with met.mp3`; 
    } else if (!track1Mute && !track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 12 Strum 4 Auld Lang Syn Mix no met.mp3`;
    } else if (!track1Mute && track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 12 Strum 4 Auld Lang Syn Stud Gtr with met.mp3`;
    } else if (track1Mute && !track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 12 Strum 4 Auld Lang Syn Vocal with met.mp3`;
    } else if (track1Mute && track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 12 Strum 4 Auld Lang Syn Met with met.mp3`;
    } else if (track1Mute && !track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 12 Strum 4 Auld Lang Syn Vocal no met.mp3`;
    } else if (!track1Mute && track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 12 Strum 4 Auld Lang Syn Stud Gtr no met.mp3`;
    } else if (track1Mute && track2Mute && track4Mute) {
