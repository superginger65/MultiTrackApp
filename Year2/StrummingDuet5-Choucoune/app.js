...
let trackToPlay = `Tracks/With Metronome/Combinations/Audio 17 Duet 5 Choucoune Mix with met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 17 Duet 5 Choucoune Mix with met.mp3`; 
    } else if (!track1Mute && !track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 17 Duet 5 Choucoune Mix no met.mp3`;
    } else if (!track1Mute && track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 17 Duet 5 Choucoune GTR with met.mp3`;
    } else if (track1Mute && !track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 17 Duet 5 Choucoune Vocals with met.mp3`;
    } else if (track1Mute && track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 17 Duet 5 Choucoune met with  met.mp3`;
    } else if (track1Mute && !track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 17 Duet 5 Choucoune Vocals no met.mp3`;
    } else if (!track1Mute && track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 17 Duet 5 Choucoune GTR no met.mp3`;
    } else if (track1Mute && track2Mute && track4Mute) {
