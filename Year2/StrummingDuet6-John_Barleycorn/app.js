...
let trackToPlay = `Tracks/With Metronome/Combinations/Audio 21 Duet 6 John Barleycorn Mix with Met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 21 Duet 6 John Barleycorn Mix with Met.mp3`; 
    } else if (!track1Mute && !track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 21 Duet 6 John Barleycorn Mix no Met.mp3`;
    } else if (!track1Mute && track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 21 Duet 6 John Barleycorn GTR with Met.mp3`;
    } else if (track1Mute && !track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 21 Duet 6 John Barleycorn Vocals with Met.mp3`;
    } else if (track1Mute && track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 21 Duet 6 John Barleycorn Met with Met.mp3`;
    } else if (track1Mute && !track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 21 Duet 6 John Barleycorn Vocals no Met.mp3`;
    } else if (!track1Mute && track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 21 Duet 6 John Barleycorn GTR no Met.mp3`;
    } else if (track1Mute && track2Mute && track4Mute) {
