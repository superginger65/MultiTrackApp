...
let trackToPlay = `Tracks/Audio 1 Duet 1 Cool Breeze Mix with met.mp3`;
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track4Mute) {
      trackToPlay = `Tracks/Audio 1 Duet 1 Cool Breeze Mix with met.mp3`; 
    } else {
      trackToPlay = `Tracks/Audio 1 Duet 1 Cool Breeze Mix no met.mp3`;
    }
    if (shouldPlay) {
