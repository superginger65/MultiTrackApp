...
let trackToPlay = `Tracks/With Metronome/Combinations/Audio 2 Duet 2 Rag Blues Mix with met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Combinations/Audio 2 Duet 2 Rag Blues Mix with met.mp3`;
    } else if (!track1Mute && track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 2 Duet 2 Rag Blues Gtr1 with met.mp3`;
    } else if (!track1Mute && !track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 2 Duet 2 Rag Blues Mix no met.mp3`;
    } else if (track1Mute && !track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 2 Duet 2 Rag Blues Gtr2 with met.mp3`;
    } else if (track1Mute && track2Mute && !track4Mute) {
      trackToPlay = `Tracks/With Metronome/Singles/Audio 2 Duet 2 Rag Blues Met  with met.mp3`;
    } else if (track1Mute && !track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 2 Duet 2 Rag Blues Gtr2 no met.mp3`;
    } else if (!track1Mute && track2Mute && track4Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 2 Duet 2 Rag Blues Gtr1 no met.mp3`;
    } else if (track1Mute && track2Mute && track4Mute) {
