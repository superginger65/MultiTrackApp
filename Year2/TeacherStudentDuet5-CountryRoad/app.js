...
let trackToPlay = `Tracks/No Metronome/Combinations/Audio 13 Duet 5 Country Road Mix no met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 13 Duet 5 Country Road Mix no met.mp3`; 
    } else if (track1Mute && !track2Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 13 Duet 5 Country Road GTR2 no met.mp3`;
    } else if (!track1Mute && track2Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 13 Duet 5 Country Road GTR1 no met.mp3`;
    } else if (track1Mute && track2Mute) {
