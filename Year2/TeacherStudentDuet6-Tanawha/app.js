...
let trackToPlay = `Tracks/No Metronome/Combinations/Audio 14 Duet 6 Tanawha mix no met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 14 Duet 6 Tanawha mix no met.mp3`; 
    } else if (track1Mute && !track2Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 14 Duet 6 Tanawha Gtr 2 no met.mp3`;
    } else if (!track1Mute && track2Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 14 Duet 6 Tanawha Gtr 1 no met.mp3`;
    } else if (track1Mute && track2Mute) {
