...
let trackToPlay = `Tracks/No Metronome/Combinations/Audio 16 Duet 7 Si Bheag Si Mhor Mix no met.mp3`;
...
let track4Mute = false;
  ...
  function toggleTrack(trackId, shouldPlay) {
    ...
    if (!track1Mute && !track2Mute) {
      trackToPlay = `Tracks/No Metronome/Combinations/Audio 16 Duet 7 Si Bheag Si Mhor Mix no met.mp3`; 
    } else if (track1Mute && !track2Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 16 Duet 7 Si Bheag Si Mhor Gtr 2 no met.mp3`;
    } else if (!track1Mute && track2Mute) {
      trackToPlay = `Tracks/No Metronome/Singles/Audio 16 Duet 7 Si Bheag Si Mhor Gtr 1 no met.mp3`;
    } else if (track1Mute && track2Mute) {
